...
1. Describe the biggest difference between `.forEach` & `.map`.
 ...
 forEach executes a function for each element in an array once.
 map returns a new array

2. What is the difference between a function and a method?

Function does not belong to an object or class
Method is a member of an object of class

3. What is closure?

Closure gives you access to an outer scope.
...
Super calls functions on an objects parents.
